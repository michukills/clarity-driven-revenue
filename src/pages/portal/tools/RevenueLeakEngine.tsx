    ...
    <PortalShell variant="customer">
      <div className="mb-6">
        ...
        <h1 className="mt-1 text-3xl text-foreground flex items-center gap-3">
          <TrendingDown className="h-7 w-7 text-destructive" /> Revenue Leak Detection Engine™
        </h1>
      ...
      {loading ? (
        ...
        <div className="bg-card border border-dashed border-border rounded-xl p-12 text-center">
          ...
          <p className="text-xs text-muted-foreground mt-2 max-w-md mx-auto">
            Your RGS team will run the Revenue Leak Detection Engine™ for your business and share the results here.
          </p>
        </div>
      ) : (
