      ...
      if (customers) {
        setStats({
          ...
          diagnostics: customers.filter((c) =>
            ["diagnostic_in_progress", "diagnostic_delivered"].includes(c.stage),
          ).length,
          implementation: customers.filter((c) =>
            ["implementation", "work_in_progress"].includes(c.stage),
          ).length,
          completed: customers.filter((c) => c.stage === "work_completed").length,
        });
