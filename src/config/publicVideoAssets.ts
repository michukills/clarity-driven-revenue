...
export const PUBLIC_VIDEO_ASSETS: PublicVideoAsset[] = [
  ...
  },
  {
    ...
    description:
      "Recorded product walkthrough of the RGS OS using sample/demo data, demo watermarking, protected internal logic, narration, and captions.",
    page_context: "/demo",
    video_status: "finished",
    video_url: "/videos/public/revenue-growth-systems-operating-system-public-demo.mp4",
    poster_url: "/videos/public/posters/revenue-growth-systems-operating-system-public-demo-poster.png",
    download_url: null,
