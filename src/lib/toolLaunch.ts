...
const ADMIN_TITLE_ROUTES: Record<string, string> = {
  ...
  "business stability index": "/admin/tools/stability-scorecard",
  "business stability index™": "/admin/tools/stability-scorecard",
  ...
  "revenue control center": "/admin/rgs-business-control-center/revenue-tracker",
  "revenue control center™": "/admin/rgs-business-control-center/revenue-tracker",
  "business control engine": "/admin/rgs-business-control-center/revenue-tracker",
};
...
const CLIENT_TITLE_ROUTES: Record<string, string> = {
  ...
  "business stability index": "/portal/scorecard",
  "business stability index™": "/portal/scorecard",
  ...
  "implementation command tracker": "/portal/tools/implementation-tracker",
  "implementation command tracker™": "/portal/tools/implementation-tracker",
  "implementation foundation system": "/portal/tools/implementation-tracker",
  "implementation foundation system™": "/portal/tools/implementation-tracker",
  "implementation roadmap": "/portal/tools/implementation-tracker",
  "onboarding worksheet": "/portal/tools/implementation-tracker",
  "weekly reflection": "/portal/tools/weekly-reflection",
  "weekly alignment system": "/portal/tools/weekly-reflection",
  "weekly alignment system™": "/portal/tools/weekly-reflection",
  ...
  "revenue leak detection engine": "/portal/tools/revenue-leak-engine",
  "revenue leak detection engine™": "/portal/tools/revenue-leak-engine",
  "buyer persona tool": "/portal/tools/self-assessment",
  "buyer intelligence engine": "/portal/tools/self-assessment",
  "buyer intelligence engine™": "/portal/tools/self-assessment",
  "customer journey mapper": "/portal/tools/self-assessment",
  "customer journey mapping system": "/portal/tools/self-assessment",
  "customer journey mapping system™": "/portal/tools/self-assessment",
  "process breakdown tool": "/portal/tools/self-assessment",
  "process clarity engine": "/portal/tools/self-assessment",
  "process clarity engine™": "/portal/tools/self-assessment",
  "revenue tracker (client)": "/portal/business-control-center/revenue-tracker",
  "revenue tracker - client": "/portal/business-control-center/revenue-tracker",
  "revenue control center": "/portal/business-control-center/revenue-tracker",
  "revenue control center™": "/portal/business-control-center/revenue-tracker",
  "business control center": "/portal/business-control-center",
};
