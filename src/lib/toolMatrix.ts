...
export const TOOL_MATRIX: ToolMatrixEntry[] = [
  // ─── Diagnostic Engines™ ────────────────────────────────────────────────
  {
    ...
    phase: "both",
    primaryUser: "admin",
    whenToUse: "Used by RGS during the assigned diagnostic engagement.",
    frequencyLabel: "Diagnostic review",
    frequency: { kind: "event", description: "Run by RGS when part of the active engagement." },
  ...
  },
  {
    ...
    phase: "both",
    primaryUser: "admin",
    whenToUse: "Used by RGS during the assigned diagnostic or implementation engagement.",
    frequencyLabel: "Diagnostic review",
    frequency: { kind: "event", description: "Run by RGS when part of the active engagement." },
  ...
  // ─── Structuring Engines™ ───────────────────────────────────────────────
  {
    ...
    primaryUser: "client",
    whenToUse: "Used during the assigned implementation engagement.",
    frequencyLabel: "Implementation support",
  ...
  // ─── Control Systems ────────────────────────────────────────────────────
  {
    ...
    phase: "ongoing",
    primaryUser: "client",
    whenToUse: "Used while your Revenue Control System subscription is active.",
    frequencyLabel: "RCS subscription",
    frequency: { kind: "weekly", overdueDays: 10 },
  ...
  },
  {
    ...
    phase: "ongoing",
    primaryUser: "both",
    whenToUse: "Published by RGS while your active subscription is in place.",
    frequencyLabel: "RCS subscription",
    frequency: { kind: "monthly", overdueDays: 35 },
...
export const PHASE_LABEL: Record<ToolPhase, string> = {
  ...
  ongoing: "RCS subscription",
  both: "Diagnostic review",
};
