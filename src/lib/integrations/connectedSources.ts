...
export const CONNECTOR_CAPABILITY_MATRIX: ConnectorCapabilityEntry[] = [
  // Accounting ────────────────────────────────────────────────────────────────
  {
    ...
    actionLabel: `Connect ${BRANDS.quickbooks}`,
  ...
  },
  {
    ...
    implementationStatus: `Planned: ${BRANDS.xero} OAuth & sync not yet shipped. RGS configures manually today.`,
  ...
  },
  {
    ...
    implementationStatus: `Planned: ${BRANDS.freshbooks} OAuth not yet shipped.`,
    statusCopy: "Direct sync planned",
    actionLabel: "Request setup",
    allowSetupRequest: true,
    supportsActiveState: true,
  ...
  // Payments ─────────────────────────────────────────────────────────────────
  {
    ...
    implementationStatus: `Planned: ${BRANDS.stripe} OAuth/API not yet shipped.`,
    statusCopy: "Direct sync planned",
    actionLabel: "Request setup",
    allowSetupRequest: true,
    supportsActiveState: true,
  },
  {
    ...
    rccAutofillFields: ["rev_collected"],
    implementationStatus: `Planned: ${BRANDS.square} OAuth not yet shipped.`,
    statusCopy: "Direct sync planned",
    actionLabel: "Request setup",
    allowSetupRequest: true,
    supportsActiveState: true,
  },
  {
    ...
    rccAutofillFields: ["rev_collected"],
    implementationStatus: `Planned: ${BRANDS.paypal} OAuth not yet shipped.`,
    statusCopy: "Direct sync planned",
    actionLabel: "Request setup",
    allowSetupRequest: true,
    supportsActiveState: true,
  ...
  // CRM / Pipeline ───────────────────────────────────────────────────────────
  {
    ...
    implementationStatus: `Planned: ${BRANDS.hubspot} OAuth not yet shipped.`,
    statusCopy: "Direct sync planned",
    actionLabel: "Request setup",
    allowSetupRequest: true,
    supportsActiveState: true,
  },
  {
    ...
    rccAutofillFields: ["pipeline_deal_count", "pipeline_deal_value", "pipeline_stage_movement"],
    implementationStatus: `Planned: ${BRANDS.salesforce} OAuth not yet shipped.`,
    statusCopy: "Direct sync planned",
    actionLabel: "Request setup",
    allowSetupRequest: true,
    supportsActiveState: true,
  },
  {
    ...
    rccAutofillFields: ["pipeline_deal_count", "pipeline_deal_value", "pipeline_stage_movement"],
    implementationStatus: `Planned: ${BRANDS.pipedrive} OAuth not yet shipped.`,
    statusCopy: "Direct sync planned",
    actionLabel: "Request setup",
    allowSetupRequest: true,
    supportsActiveState: true,
  ...
  },
  {
    ...
    implementationStatus: `Planned: ${BRANDS.metaAds} OAuth not yet shipped. Marketing-only.`,
    statusCopy: "Direct sync planned",
    actionLabel: "Request setup",
    allowSetupRequest: true,
    supportsActiveState: true,
  ...
  // Payroll / Labor ──────────────────────────────────────────────────────────
  {
    ...
    implementationStatus: `Planned: ${BRANDS.paycom} not yet shipped.`,
    statusCopy: "Direct sync planned",
    actionLabel: "Request setup",
    allowSetupRequest: true,
    supportsActiveState: true,
  },
  {
    ...
    expectedSyncedObjects: ["Payroll run", "Headcount", "Hours"],
    rccAutofillFields: ["payroll_cost", "labor_hours", "headcount"],
    implementationStatus: `Planned: ${BRANDS.adp} not yet shipped.`,
    statusCopy: "Direct sync planned",
    actionLabel: "Request setup",
    allowSetupRequest: true,
    supportsActiveState: true,
  },
  {
    ...
    expectedSyncedObjects: ["Payroll run", "Headcount", "Hours"],
    rccAutofillFields: ["payroll_cost", "labor_hours", "headcount"],
    implementationStatus: `Planned: ${BRANDS.gusto} not yet shipped.`,
    statusCopy: "Direct sync planned",
    actionLabel: "Request setup",
    allowSetupRequest: true,
    supportsActiveState: true,
  ...
  // Field Ops ────────────────────────────────────────────────────────────────
  {
    ...
    implementationStatus: `Planned: ${BRANDS.jobber} not yet shipped.`,
    statusCopy: "Direct sync planned",
    actionLabel: "Request setup",
    allowSetupRequest: true,
    supportsActiveState: true,
  },
  {
    ...
    rccAutofillFields: ["rev_pending"],
    implementationStatus: `Planned: ${BRANDS.housecallPro} not yet shipped.`,
    statusCopy: "Direct sync planned",
    actionLabel: "Request setup",
    allowSetupRequest: true,
    supportsActiveState: true,
  },
  {
    ...
    rccAutofillFields: ["rev_pending"],
    implementationStatus: `Planned: ${BRANDS.serviceTitan} not yet shipped.`,
    statusCopy: "Direct sync planned",
    actionLabel: "Request setup",
    allowSetupRequest: true,
    supportsActiveState: true,
